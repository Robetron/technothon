...
<tr>
<td>
<label for="roomid">Room Name  </label></td><td>
...
<tr><td>
<label for="training_type" >Training Type</label></td>
<td>
...
<tr><td>
<label for="training_name">Training Name </label></td><td><input type="text" id="training_name" name="training_name" required></td></tr>

<tr><td>
			<p><b>Appointment time:</b></p></td></tr>
			<tr>
<td>Full Day Booking</td><td><input type="checkbox" id="fullDay" checked="checked"></td>
</tr>
			<tr><td>
	      				<h3> StartTime </h3></td><td>	<input type="time" id="starttime" name="stime" required></td></tr>
	  					<tr><td><h3> EndTime </h3></td><td>	<input type="time" id="endtime" name="etime" required></td></tr>
	  					</table>
	  				<!-- 	<h3>Duration</h3>	<input type="text" id="duration"> -->
	  					<p><h3>Recurrence pattern</h3></p>
	  					<table id="recurrence">
	   						<tr>
	  						<td>
...
<!-- 	  						<tr><td><b>Daily  </b></td><td><input type="radio" name="recur" value="Daily"></td></tr>
 -->	  						<tr><td><b>Weekly</b></td><td><input type="radio" name="recur" value="Weekly" required></td></tr>
	  						<tr><td><b>Monthly</b></td><td><input type="radio" name="recur" value="Monthly" required></td></tr>
<!-- 	  						<tr><td><b>Yearly  </b></td><td><input type="radio" name="recur" value="Yearly"></td></tr>	
 -->	  						</table>
	  					...
	  					<tr><td><b>Start : </b><input id="start" type="date" style="width: 120px" name="sdate" required></td></tr>
	  					<tr><td><input type="radio" name="range" value="No end date" required><b>No end date</b></td></tr>
	  					<tr><td><input type="radio" name="range" value="End after" required><b>End after : </b><input type="number" id="occurrences" style="width: 50px" name="count" min="1" value="1"> Occurrences</td></tr>
	  					<tr><td><input id="endBy" type="radio" name="range" value="End by" required><b>End by :</b><input type="date" id="end" style="width: 120px" name="edate"></td></tr>
	  					
	  					</table>
	  					<button class="button btn btn-primary btn-large" style="float:center;" name="click" value="OK">OK</button>
	  					<a href="applicationUser.jsp" class="button btn btn-primary btn-large" style="float:center;">Cancel</a>
