	     ...
	     <div class="row">
	      	...
	      	<div class="widget-header">
						...
						<h3>End Date</h3>
	  					...
	  					Softskill -->       <input type="submit" id="go" class="button btn btn-primary btn-large">
            ...
            <!--  <div id="tbhead" style="width:100%;height:250px;overflow:auto;margin:0 auto;"></div> -->
                 ...
                 <div id="tablediv" style="width: 100%; height: 750px;margin: 0 auto; overflow: auto;">
           ...
           <!-- </div>     -->   
                  ...
                  <button class="button btn btn-primary btn-large" onClick="window.location='book1.jsp';" id="book">Book Room</button >
                  <a href="recurrenceForm.jsp" class="button btn btn-primary btn-large">Recurrence </a> 
                  <a href="viewbooking.jsp" target="_parent"><button class="button btn btn-primary btn-large" id="view">View My Bookings</button></a>
                  <a href="viewbookingall.jsp" target="_parent"><button class="button btn btn-primary btn-large" id="view">View All Bookings</button></a>
                   </div>
                  </div>
               </div>
