		...
		<form action="RoomController" method="post">
			...
			<div class="login-fields">
				...
				<div class="field">
					...
					<input type="text"  name="roomname" value="" placeholder="Room Name" class="login" required="required"/>
				</div>
				
				<div class="field">
					<label for="lastname">Capacity:</label>	
					<input type="number" id="capacity" name="capacity" value="" placeholder="Capacity" class="login" required="required" />
				</div>
